		...
		<div>
			<?php
				...
				if(mysqli_query($connection, $sql)){
					echo "<br><br>The database — <b>DEPARTMENT</b> is Successfully Created";
				}
				else{
					echo "<br><b>ERROR! Unable to create the database — DEPARTMENT</b><br><br>" . mysqli_error($connection);
				}
