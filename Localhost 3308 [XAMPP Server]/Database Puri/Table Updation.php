...
<html>
	...
	<body>
		<?php
			...
			//Table Updation...
			$sql = "UPDATE HOTEL SET CONTACT = 06752221700 WHERE NAME = 'HOTEL PULIN PURI';";

			//Check whether the given sql query is successfully processed or Not...
			if(mysqli_query($connection, $sql)){
				echo "<br><br><br><font>The table - HOTEL is Successfully Updated</font>";
				...
				echo "<br><br><br><font>ERROR! Unable to update the table - HOTEL </font>" . mysqli_connect_error();
			}
