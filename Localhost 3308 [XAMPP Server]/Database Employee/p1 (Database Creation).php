		...
		<div>
			<?php
				...
				if(mysqli_query($connection, $sql)){
					echo "<br><font>The database — <b>EMPLOYEE</b> is Successfully Created</font>";
				}
				else{
					echo "<br><b>ERROR! Unable to create the database — EMPLOYEE</b><br><br>" . mysqli_error($connection);
				}
