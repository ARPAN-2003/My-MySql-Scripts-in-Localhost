		...
		<div>
			<?php
				if($_SERVER["REQUEST_METHOD"] == "POST"){
					...
					//Data Display...
					$sql = "SELECT * FROM STUDENT WHERE ROLL IN (SELECT ROLL FROM LOGIN WHERE USERNAME = '$username' AND PASSWORD = '$password');";

					$results = mysqli_query($connection, $sql);
					
					if(mysqli_num_rows($results) > 0){
						echo "<font>You have successfully Logged in your profile : </font><br><br>";
